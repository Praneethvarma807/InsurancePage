          ...
          <div className="insurance-page0-check-div">
            <li>
              ...
              <p>
                ...
                its representatives to contact me via calls, WhatsApp, or email
                to verify the information I’ve provided. I understand that this
                may include contacting me even if I’m on the 'Do Not Call' list.
                I also consent to sharing my information with trusted third
                parties (like call centers or service partners) for processing
                this application."
              </p>
            </li>
            <li>
              <input type="checkbox" name="check" id="check" required />
              <p>
                "I choose to skip the suitability module, even though it is
                recommended."
              </p>
            </li>
          </div>
